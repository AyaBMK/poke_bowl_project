        ...
        <div class="w-full bg-white rounded-lg shadow md:mt-0 sm:max-w-md xl:p-0">
            <div class="p-6 space-y-4 md:space-y-6 sm:p-8">
                ...
                if (isset($_GET['succes'])) { ?>
                    <div class="flex items-center p-4 mb-4 text-sm text-green-900 border border-green-400 rounded-lg bg-green-50 dark:text-green-400"
                        role="alert">
                        <svg class="flex-shrink-0 inline w-4 h-4 mr-3" aria-hidden="true" xmlns="http://www.w3.org/2000/svg"
                            fill="currentColor" viewBox="0 0 20 20">
                            <path
                ...
                <form class="space-y-4 md:space-y-6" action="login_process.php" method="POST">
                    ...
                    <div class="flex items-center justify-between">
                      ...
                      <a href="#" class="text-sm font-medium text-primary-600 hover:underline dark:text-green-800">Forgot password?</a>
                  </div>
                    <button type="submit"
